    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Numbers") {
                    TextField("Pain level (/10)", text: $value1Text)
                ...
                Section("Trigger/notes") {
                    TextField("Notes", text: $notes, axis: .vertical)
                        .focused($focusedField, equals: .notes)
                        .accessibilityIdentifier("notesField")
                }
            }
            .navigationTitle(entry == nil ? "New Flare-up" : "Edit Flare-up")
            .toolbar {
